...
class Application
{
    ...
    public function __construct()
    {
        ...
        if (file_exists('./application/controller/' . $this->url_controller . '.php')) {
            ...
            if (method_exists($this->url_controller, $this->url_action)) {
            	...
            	{
            		// invalid URL, so simply show home/error404
    ...
    private function splitUrl()
    {
        if(CLI)
        {
             ...
             * Console exectution
             */
            $this->url_controller = (isset($_SERVER["argv"][1]) ? $_SERVER["argv"][1] : null);
            $this->url_action = (isset($_SERVER["argv"][2]) ? $_SERVER["argv"][2] : null);
            $this->url_parameter_1 = (isset($_SERVER["argv"][3]) ? $_SERVER["argv"][3] : null);
            $this->url_parameter_2 = (isset($_SERVER["argv"][4]) ? $_SERVER["argv"][4] : null);
            $this->url_parameter_3 = (isset($_SERVER["argv"][5]) ? $_SERVER["argv"][5] : null);
